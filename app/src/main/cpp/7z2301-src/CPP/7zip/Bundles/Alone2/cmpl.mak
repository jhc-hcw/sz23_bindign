...
ifdef SystemDrive
$(info "定义了 SystemDrive 并且 IS_MINGW is true")
IS_MINGW = 1
else
ifdef SYSTEMDRIVE
$(info "定义了 SYSTEMDRIVE 并且 IS_MINGW is true")
...
ifdef USE_ASM
CONSOLE_ASM_FLAGS=-DZ7_7ZIP_ASM  #如果定义了使用汇编代码，则会启用该宏定义。
else
$(info "没有使用 ASM")
CONSOLE_ASM_FLAGS=
endif
