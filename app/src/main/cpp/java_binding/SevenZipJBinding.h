...
#define DIRITEMCALLBACK "net/sf/sevenzipjbinding/IDirItemCallback"
#define DIRITEMCALLBACK_CLASS_T    JAVA_MAKE_SIGNATURE_TYPE(DIRITEMCALLBACK)

#define IEXTRACTCALLBACKUI "net/sf/sevenzipjbinding/IExtractCallbackUI"
#define IEXTRACTCALLBACKUI_CLASS_T    JAVA_MAKE_SIGNATURE_TYPE(IEXTRACTCALLBACKUI)

#define IUPDATECALLBACK "net/sf/sevenzipjbinding/IUpdateCallback"
#define IUPDATECALLBACK_CLASS_T    JAVA_MAKE_SIGNATURE_TYPE(IUPDATECALLBACK)
...
#include "JavaStandardLibrary.h" // TODO Move from here
